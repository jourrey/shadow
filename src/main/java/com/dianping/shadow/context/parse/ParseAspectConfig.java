...
public class ParseAspectConfig {
    private static final Logger LOG = LogManager.getLogger(ParseAspectConfig.class);
    ...
    private static AspectDefinition aspectConfig2AspectDefinition(AspectConfig aspectConfig) {
        ...
        return AspectDefinition.AspectDefinitionBuilder.create(aspectConfig.annotation()
                , annotation2AspectJExpression(aspectConfig.annotation())
     ...
     * @return
     */
    private static String annotation2AspectJExpression(Class<? extends Annotation> annotation) {
        return MessageFormat.format("@annotation（{0})", annotation);
    }

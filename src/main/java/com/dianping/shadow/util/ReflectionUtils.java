...
public class ReflectionUtils {
    private static final int CALLER_CLASS_HIERARCHY = 2;
    /**
     * Cache for {@link Class#getDeclaredMethods()}, allowing for fast resolution.
     */
    private static final Cache<Class<?>, Method[]> declaredMethodsCache = CacheBuilder.newBuilder()
            .weakKeys()
            .weakValues()
            .build();
    ...
    public static StackTraceElement getStackTraceElement(int hierarchy) {
        ...
        hierarchy += CALLER_CLASS_HIERARCHY;
        hierarchy = hierarchy > stackTraceElements.length ? stackTraceElements.length : hierarchy;
    ...
    /**
     * Perform the given callback operator on all matching methods of the given
    ...
    private static Method[] getDeclaredMethods(final Class<?> clazz) {
        ...
        try {
            result = declaredMethodsCache.get(clazz, new Callable<Method[]>() {
                @Override
    ...
    public interface MethodCallback {
        ...
        /**
         * Perform an operator using the given method.
         *
    ...
    public interface FieldCallback {
        ...
        /**
         * Perform an operator using the given field.
         *

...
public abstract class ClassUtils {
    ...
    /**
     * Loads a class by name. If this property is specified and set to anything besides {@code false}
     * , then the default ClassLoader will be used.
     *
     ...
     * @return
     */
    public static <T> T newInstanceOf(final Class<T> clazz) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        try {
    ...
    public static String getShortName(String className) {
        checkArgument(StringUtils.isNotBlank(className), "Class name must not be empty");
    ...
    public static Class<?> createCompositeInterface(Class<?>[] interfaces, ClassLoader classLoader) {
        checkArgument(ArrayUtils.isNotEmpty(interfaces), "Interfaces must not be empty");

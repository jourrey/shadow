 ...
 * <bean class="com.dianping.shadow.aspect.spring.AnnotationSpringAspectInterceptor" />
 *
 * @author jourrey
 */
@Aspect
public class AnnotationSpringAspectInterceptor extends SpringAspectInterceptor {
